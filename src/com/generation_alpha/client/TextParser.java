...
//      For Hunter X level
        ...
        try {
            // HunterX - TownCenter
            Object obj1 = parser.parse(new FileReader("C:\\StudentWork\\generation-alpha\\JsonObjects\\hunterx.json"));
            JSONObject jsonObject1 = (JSONObject) obj1;
            Object tc1 = jsonObject1.get("Town Center");
            JSONObject townCenter = (JSONObject) tc1;

            // Talon
            Object obj2 = parser.parse(new FileReader("C:\\StudentWork\\generation-alpha\\JsonObjects\\talon.json"));
            JSONObject jsonObject2 = (JSONObject) obj2;
            Object tc2 = jsonObject2.get("Stairway to Heaven");
            JSONObject talon = (JSONObject) tc2;

            // Troll
            Object obj3 = parser.parse(new FileReader("C:\\StudentWork\\generation-alpha\\JsonObjects\\troll.json"));
            JSONObject jsonObject3 = (JSONObject) obj3;
            Object tc3 = jsonObject3.get("Bridge of Death");
            JSONObject troll = (JSONObject) tc3;

            // Master Yamamoto
            Object obj4 = parser.parse(new FileReader("C:\\StudentWork\\generation-alpha\\JsonObjects\\masteryamamoto.json"));
